...
task release, "Build tg_to_pocket and generate_token":
    exec "nimble c -d:ssl -d:useOpenssl3 -d:release -f:on -o:build/tg_to_pocket src/tg_to_pocket"
    exec "nimble c -d:ssl -d:useOpenssl3 -d:release -f:on -o:build/generate_token src/generate_token"
